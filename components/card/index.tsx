...
export default function Card({ mt, cover_img_url, description, name, opensea_url, parcel_id, parcel_page_url, type }: Props) {
        ...
        <div className={cn(style.container, mt)} onClick={toParcel}>
            <div className={style.container2}>
                <div className={style.banner}>
                    <img src={cover_img_url} className={style.banner}>
                    </img>
